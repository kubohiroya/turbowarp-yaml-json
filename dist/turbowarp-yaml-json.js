...
(function (Scratch) {
  ...
  var extensionConfig = {
  	...
  	license: "MPL-2.0",
  	unsandboxed: false,
  	docsURI: "https://kubohiroya.github.io/turbowarp-yaml-json/",
  ...
  var block_definitions_default = {
  	extensionName: "TurboWarp YAML/JSON",
  	menus: { "parseFormat": {
  	...
  	blocks: [
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "string [VALUE]",
  			"description": "Creates a string value.",
  			"arguments": { "VALUE": {
  				"type": "STRING",
  				"defaultValue": "sensor"
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "number [VALUE]",
  			"description": "Creates a finite number value.",
  			"arguments": { "VALUE": {
  				"type": "NUMBER",
  				"defaultValue": 21
  			} }
  		...
  		},
  		{
  			"opcode": "pair",
  			"blockType": "REPORTER",
  			"text": "pair key [KEY] value [VALUE]",
  			"description": "Creates a map key/value pair.",
  			"arguments": {
  				"KEY": {
  					"type": "STRING",
  		...
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "map [ENTRIES]",
  			"description": "Creates an object/map from pair fragments.",
  			"arguments": { "ENTRIES": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "sequence [ITEMS]",
  			"description": "Creates an array/sequence from item fragments.",
  			"arguments": { "ITEMS": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"description": "Combines fragments without mutating either input.",
  			"arguments": {
  				"LEFT": {
  					"type": "STRING",
  					"defaultValue": ""
  		...
  		},
  		{
  			"opcode": "renderYaml",
  			"blockType": "REPORTER",
  			"text": "render YAML [FRAGMENT]",
  			"description": "Renders a fragment to YAML text.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			"opcode": "renderJson",
  			"blockType": "REPORTER",
  			"text": "render JSON [FRAGMENT]",
  			"description": "Renders a fragment to formatted JSON text.",
  			"arguments": { "FRAGMENT": {
  				"type": "STRING",
  				"defaultValue": ""
  			} }
  		},
  		{
  			...
  			"blockType": "REPORTER",
  			"text": "validate JSON Schema [SCHEMA] data [FRAGMENT]",
  			"description": "Returns JSON Schema validation details for the built data.",
  			"arguments": {
  				"SCHEMA": {
  					"type": "STRING",
  					"defaultValue": "{\"type\":\"object\",\"required\":[\"temperature\"]}"
  				},
  				"FRAGMENT": {
  					"type": "STRING",
  					"defaultValue": ""
  		...
  		},
  		{
  			...
  			"blockType": "BOOLEAN",
  			"text": "JSON Schema [SCHEMA] accepts data [FRAGMENT]?",
  			"description": "Reports whether the built data passes JSON Schema validation.",
  			"arguments": {
  				"SCHEMA": {
  					"type": "STRING",
  					"defaultValue": "{\"type\":\"object\",\"required\":[\"temperature\"]}"
  		...
  		},
  		{
  			"opcode": "parseText",
  			"blockType": "REPORTER",
  			"text": "parse [TEXT] as [FORMAT]",
  			"description": "Safely parses the provided YAML or JSON text into a fragment.",
  			"arguments": {
  				"TEXT": {
  					"type": "STRING",
  					"defaultValue": "name: sensor"
  				},
  				"FORMAT": {
  					"type": "STRING",
  					"defaultValue": "auto",
  		...
  		},
  		{
  			...
  			"blockType": "BOOLEAN",
  			"text": "last parse succeeded?",
  			"description": "Reports whether the most recent parse operation succeeded.",
  			"arguments": {}
  		},
  		{
  			"opcode": "lastParseFormat",
  			"blockType": "REPORTER",
  			"text": "last parse format",
  			"description": "Reports the format selected by the most recent parse operation.",
  			"arguments": {}
  		},
  		{
  			"opcode": "lastParseDiagnostic",
  			"blockType": "REPORTER",
  			"text": "last parse diagnostic",
  			"description": "Reports the code, location, and message for the most recent parse failure.",
  			"arguments": {}
  		},
  		{
  			"opcode": "lastParseLine",
  			"blockType": "REPORTER",
  			"text": "last parse error line",
  			"description": "Reports the one-based line of the most recent parse failure, or zero when unavailable.",
  			"arguments": {}
  		},
  		{
  			"opcode": "lastParseColumn",
  			"blockType": "REPORTER",
  			"text": "last parse error column",
  			"description": "Reports the one-based column of the most recent parse failure, or zero when unavailable.",
  			"arguments": {}
  		}
  	]
  };
  ...
  //#endregion
  //#region node_modules/.pnpm/fast-uri@3.1.6/node_modules/fast-uri/lib/utils.js
  ...
  //#endregion
  //#region node_modules/.pnpm/fast-uri@3.1.6/node_modules/fast-uri/lib/schemes.js
  ...
  //#endregion
  //#region node_modules/.pnpm/fast-uri@3.1.6/node_modules/fast-uri/index.js
  var require_fast_uri = /* @__PURE__ */ __commonJSMin(((exports, module) => {
  	...
  	*/
  	function canonicalizeHost(parsed, options, schemeHandler, isIP) {
  		if (!options.unicodeSupport && (!schemeHandler || !schemeHandler.unicodeSupport) && parsed.host && parsed.host[0] !== "[" && (options.domainHost || schemeHandler && schemeHandler.domainHost) && isIP === false && nonSimpleDomain(parsed.host)) try {
  ...
  var import_ajv = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
  	Object.defineProperty(exports, "__esModule", { value: true });
  ...
  */
  function visit$2(text, visitor, options = ParseOptions.DEFAULT) {
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/identity.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/visit.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/doc/directives.js
  var escapeChars = {
  	"!": "%21",
  	",": "%2C",
  	"[": "%5B",
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/doc/anchors.js
  /**
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/doc/applyReviver.js
  /**
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/toJS.js
  /**
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/Node.js
  var NodeBase = class {
  	constructor(type) {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/Alias.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/Scalar.js
  var isScalarValue$1 = (value) => !value || typeof value !== "function" && typeof value !== "object";
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/doc/createNode.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/Collection.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyComment.js
  /**
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/foldFlowLines.js
  var FOLD_FLOW = "flow";
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyString.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringify.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyPair.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/log.js
  function warn(logLevel, warning) {
  	if (logLevel === "debug" || logLevel === "warn") console.warn(warning);
  }
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/merge.js
  var MERGE_KEY = "<<";
  var merge = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/addPairToJSMap.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/Pair.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyCollection.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/YAMLMap.js
  	...
  	*/
  	add(pair, overwrite) {
  		...
  		if (prev) {
  			...
  			if (isScalar(prev.value) && isScalarValue$1(_pair.value)) prev.value.value = _pair.value;
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/common/map.js
  var map$1 = {
  	collection: "map",
  	default: true,
  	nodeClass: YAMLMap,
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/nodes/YAMLSeq.js
  var YAMLSeq = class extends Collection {
  	...
  	*/
  	set(key, value) {
  		...
  		if (isScalar(prev) && isScalarValue$1(value)) prev.value = value;
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/common/seq.js
  var seq = {
  	collection: "seq",
  	default: true,
  	nodeClass: YAMLSeq,
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/common/string.js
  var string = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/common/null.js
  var nullTag = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/core/bool.js
  var boolTag = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyNumber.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/core/float.js
  var floatNaN$1 = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/core/int.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/core/schema.js
  var schema$2 = [
  	map$1,
  	seq,
  	string,
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/json/schema.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/binary.js
  var binary = {
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/pairs.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/omap.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/bool.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/float.js
  var floatNaN = {
  	identify: (value) => typeof value === "number",
  	default: true,
  	tag: "tag:yaml.org,2002:float",
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/int.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/set.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/timestamp.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/yaml-1.1/schema.js
  var schema = [
  	map$1,
  	seq,
  	string,
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/tags.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/schema/Schema.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/stringify/stringifyDocument.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/doc/Document.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/errors.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-props.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/util-contains-newline.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/util-flow-indent-check.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/util-map-includes.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-block-map.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-block-seq.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-end.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-flow-collection.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/compose-collection.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-block-scalar.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/resolve-flow-scalar.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/compose-scalar.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/util-empty-scalar-position.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/compose-node.js
  var CN = {
  	composeNode,
  	composeEmptyNode
  };
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/compose-doc.js
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/compose/composer.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/parse/cst-visit.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/parse/lexer.js
  function isEmpty(ch) {
  	switch (ch) {
  		case void 0:
  		case " ":
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/parse/line-counter.js
  /**
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/parse/parser.js
  ...
  */
  ...
  //#endregion
  //#region node_modules/.pnpm/yaml@2.9.1/node_modules/yaml/browser/dist/public-api.js
  ...
  var SIMPLE_KEY_PATTERN = /^[A-Za-z_][A-Za-z0-9_-]*$/u;
  ...
  function concat(left, right) {
  	const children = [...flattenConcat(left), ...flattenConcat(right)].filter((child) => child.kind !== "empty");
  ...
  function toValue(fragment) {
  	switch (fragment.kind) {
  		...
  		case "scalar": return fragment.value;
  		case "pair": return { [fragment.key]: toValue(fragment.value) };
  		case "map": return Object.fromEntries(fragment.entries.map((entry) => [entry.key, toValue(entry.value)]));
  		case "sequence": return fragment.items.map(toValue);
  		case "concat": return mergeTopLevelValues(fragment.children);
  	}
  }
  function validateWithJsonSchema(schemaJson, fragment) {
  	let schema;
  	try {
  	...
  	try {
  		...
  		if (validate(toValue(fragment))) return {
  			valid: true,
  			errors: []
  		};
  		return {
  ...
  function normalizeEntries(entries) {
  	...
  	if (children.every((child) => child.kind === "pair")) return children;
  ...
  function mergeTopLevelValues(children) {
  	const values = children.filter((child) => child.kind !== "empty").map(toValue);
  	if (values.length === 0) return null;
  	if (values.every(isPlainObject)) return Object.assign({}, ...values);
  	return values;
  }
  ...
  function formatAjvErrors(errors) {
  	...
  	return errors.map((error) => {
  		return `${error.instancePath.length > 0 ? error.instancePath : "$"} ${error.message ?? "is invalid"}`;
  	});
  }
  ...
  function parseJson(source) {
  	...
  	if (syntaxError !== void 0) return failure("json", {
  		code: "INVALID_JSON",
  ...
  function parseYaml(source) {
  	...
  	if (warning !== void 0) return failure("yaml", {
  		code: warning.code,
  ...
  function fragmentFromUnknown(value, budget, depth) {
  ...
  function fragmentFromYamlNode(node, budget, depth, lineCounter) {
  	consumeBudget(budget, depth, nodePosition(node, lineCounter));
  	if (node === null) return nullValue();
  	if (isAlias(node)) throw new ParseLimitError({
  ...
  function yamlPairToFragment(item, budget, depth, lineCounter) {
  	if (!isScalar(item.key) || typeof item.key.value !== "string") throw new ParseLimitError({
  ...
  function consumeBudget(budget, depth, position = {
  	line: 0,
  	column: 0
  }) {
  	if (depth > PARSE_LIMITS.maxDepth) throw new ParseLimitError({
  		code: "MAX_DEPTH_EXCEEDED",
  		message: `Parsed data exceeds the maximum nesting depth of ${PARSE_LIMITS.maxDepth}.`,
  		...position
  	});
  	budget.nodes += 1;
  	if (budget.nodes > PARSE_LIMITS.maxNodes) throw new ParseLimitError({
  		code: "MAX_NODES_EXCEEDED",
  		message: `Parsed data exceeds the maximum node count of ${PARSE_LIMITS.maxNodes}.`,
  		...position
  	});
  }
  function validateInputSize(source) {
  ...
  function resolveFormat(source, format) {
  ...
  function failure(format, diagnostic) {
  	return {
  		success: false,
  		format,
  		fragment: null,
  ...
  function nodePosition(node, lineCounter) {
  	if (typeof node !== "object" || node === null || !("range" in node)) return {
  		line: 0,
  		column: 0
  	};
  	const range = node.range;
  	const offset = Array.isArray(range) && typeof range[0] === "number" ? range[0] : void 0;
  	return offset === void 0 ? {
  		line: 0,
  		column: 0
  	} : yamlPosition(lineCounter, offset);
  }
  function yamlPosition(lineCounter, offset) {
  ...
  var ParseLimitError = class extends Error {
  ...
  var SERIALIZED_PREFIX = "turbowarp-yaml-json:v1:";
  var blockDefinitions = block_definitions_default.blocks;
  var menuDefinitions = block_definitions_default.menus;
  var YamlJsonExtension = class {
  	constructor() {
  		this.lastParse = {
  			success: false,
  			format: "",
  	...
  	validateSchema(args) {
  		return formatValidationResult(validateWithJsonSchema(Scratch.Cast.toString(args.SCHEMA), decodeOrString(args.FRAGMENT, true)));
  	}
  	isValidSchema(args) {
  		return validateWithJsonSchema(Scratch.Cast.toString(args.SCHEMA), decodeOrString(args.FRAGMENT, true)).valid;
  	}
  	parseText(args) {
  		const result = parseData(Scratch.Cast.toString(args.TEXT), normalizeParseFormat(Scratch.Cast.toString(args.FORMAT)));
  		this.lastParse = {
  	...
  	lastParseDiagnostic() {
  		...
  		const location = diagnostic.line > 0 ? ` at line ${diagnostic.line}, column ${diagnostic.column}` : "";
  ...
  function normalizeParseFormat(value) {
  ...
  function decodeOrString(value, blankAsEmpty = false) {
  	...
  	return parseFragment(raw.slice(23));
  }
  ...
  function isFragment(value) {
  	...
  	if (record.kind === "pair") return typeof record.key === "string" && isFragment(record.value);
  	if (record.kind === "map") return Array.isArray(record.entries) && record.entries.every(isPairFragment);
  	if (record.kind === "sequence") return Array.isArray(record.items) && record.items.every(isFragment);
  	if (record.kind === "concat") return Array.isArray(record.children) && record.children.every(isFragment);
  	return false;
  }
  function isPairFragment(value) {
